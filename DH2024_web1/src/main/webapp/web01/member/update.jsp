...
<body>
	      ...
	      <div class="col-md-10 mx-auto col-lg-5">
	        ...
	        <form class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
	         ...
	         <div class="form-floating mb-3 mimgbox">
	          ...
	          <div class="form-floating mb-3"> <!-- !!!ID 수정 안함!!! -->
	          ...
	          <div class="form-floating mb-3"> 
	            <input type="text"  name="mpwd" class="form-control mpwd" id="floatingInput" placeholder="계정아이디">
	            <label for="floatingInput">계정 비밀번호</label> 
	          </div>     
	 
	          <div class="form-floating mb-3">
	            <input type="text"  name="mname" class="form-control mname" id="floatingInput" placeholder="계정아이디">
	            <label for="floatingInput">계정 닉네임</label>
	          </div>
	          	    
	          <div class="form-floating mb-3">
	            <input type="text" name="mphone" class="form-control mphone" id="floatingInput" placeholder="계정연락처">
    ...
    <script src="/DH2024_web1/web01/js/member/update.js"></script>
</body>
</html>